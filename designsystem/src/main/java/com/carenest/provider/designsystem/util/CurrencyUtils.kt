package com.carenest.provider.designsystem.util
...
import com.carenest.provider.designsystem.domain.entity.ExchangeRate
...
fun formatPrice(price: Double): String {
    ...
    val symbol = when (targetCurrency) {
        "EGP" -> stringResource(com.carenest.provider.designsystem.R.string.currency_egp)
        "GBP" -> stringResource(com.carenest.provider.designsystem.R.string.currency_gbp)
        "JPY" -> stringResource(com.carenest.provider.designsystem.R.string.currency_jpy)
        "EUR" -> stringResource(com.carenest.provider.designsystem.R.string.currency_eur)
        "USD" -> stringResource(com.carenest.provider.designsystem.R.string.currency_usd)
        else -> targetCurrency
    }
